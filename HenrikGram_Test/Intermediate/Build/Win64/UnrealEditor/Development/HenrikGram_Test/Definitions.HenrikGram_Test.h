...
#define UE_PROJECT_NAME HenrikGram_Test
#define UE_TARGET_NAME HenrikGram_TestEditor
#define UE_MODULE_NAME "HenrikGram_Test"
...
#define HENRIKGRAM_TEST_API DLLEXPORT
